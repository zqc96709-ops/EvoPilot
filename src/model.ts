...
export const entities: EntityConfig[] = [
  ...
  { entity: 'deliverables', label: '成果资产', singular: '成果资产', icon: '▣', titleKey: 'title', description: '正式输出资产的元数据；复用 Notebook 文件，不复制原始文件。', fields: [
    ...
    { key: 'versionNumber', label: '版本号' }, { key: 'fileId', label: 'Notebook 文件', relation: 'notebookFiles' }, { key: 'previousDeliverableId', label: '上一版本', relation: 'deliverables' }, { key: 'resultId', label: '所属结果', relation: 'results' }, { key: 'projectId', label: '项目', relation: 'projects' }, { key: 'decisionId', label: '决策', relation: 'decisions' }, { key: 'workflowRunId', label: '工作链运行', relation: 'workflowRuns' }, { key: 'tags', label: '标签（逗号分隔）' }, { key: 'finalizedAt', label: '正式完成时间', type: 'datetime-local' },
  ] },
