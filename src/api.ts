...
export type NotebookFilePreview = { kind: 'text' | 'pdf' | 'image' | 'audio' | 'video' | 'spreadsheet' | 'document' | 'unsupported'; text?: string; dataUrl?: string; page?: number; pageCount?: number; reason?: string; extractStatus?: string; sheets?: SpreadsheetSheetPreview[]; truncated?: boolean; rowLimit?: number; columnLimit?: number }
