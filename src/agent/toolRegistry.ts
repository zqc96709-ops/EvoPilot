...
export const toolRegistry: ToolDefinition[] = [
  ...
  tool('searchCapabilities', '搜索已有能力资产、版本和可迁移性；只读取本地记录', 'capabilityAssets', 'READ', 'READ', false), tool('getCapabilityPack', '读取能力包及其引用，不复制资产内容', 'capabilityPacks', 'READ', 'READ', false), tool('createCapabilityPack', '创建能力包草稿；资产引用需要用户明确选择', 'capabilityPacks', 'CREATE', 'MEDIUM_WRITE', true), tool('updateCapabilityPack', '更新能力包元数据或引用编排', 'capabilityPacks', 'UPDATE', 'MEDIUM_WRITE', true),
  tool('createCapabilityAssetDraft', '创建能力资产草稿；不得自动发布为正式方法', 'capabilityAssets', 'CREATE', 'MEDIUM_WRITE', true), tool('getCapabilityAsset', '读取能力资产及其当前版本', 'capabilityAssets', 'READ', 'READ', false), tool('updateCapabilityAsset', '更新能力资产元数据，不直接改写已发布版本内容', 'capabilityAssets', 'UPDATE', 'MEDIUM_WRITE', true), tool('createCapabilityVersionDraft', '从现有资产创建下一版能力草稿；不会替代已发布版本', 'capabilityAssetVersions', 'CREATE', 'MEDIUM_WRITE', true), tool('getCapabilityVersion', '读取能力资产版本或模板定义', 'capabilityAssetVersions', 'READ', 'READ', false), tool('createCapabilityPackItem', '向能力包添加一个现有能力资产引用；不会复制资产', 'capabilityPackItems', 'CREATE', 'MEDIUM_WRITE', true),
  tool('createCapabilityImprovementProposal', '根据成果、复盘或洞见创建能力改进提案；不会自动发布或验证', 'capabilityImprovementProposals', 'CREATE', 'MEDIUM_WRITE', true), tool('updateCapabilityImprovementProposal', '更新能力改进提案状态', 'capabilityImprovementProposals', 'UPDATE', 'MEDIUM_WRITE', true),
