...
const required: Partial<Record<Entity, string[]>> = {
  goals: ['title'], projects: ['title'], tasks: ['title'], timeLogs: ['title', 'startAt'], results: ['title'], deliverables: ['title'], resultPackages: ['title'], capabilityPacks: ['title'], capabilityAssets: ['title', 'assetKind'], capabilityAssetVersions: ['title', 'capabilityAssetId', 'versionNumber'], capabilityPackItems: ['packId', 'capabilityAssetId'], packApplications: ['title', 'packId', 'projectId'], packApplicationItems: ['title', 'packApplicationId'], templateInstances: ['title', 'sourceCapabilityAssetVersionId'], capabilityImprovementProposals: ['title', 'capabilityAssetId'], workflows: ['name'], workflowVersions: ['workflowId', 'versionNumber'], workflowSteps: ['workflowVersionId', 'title'], workflowGates: ['workflowVersionId', 'title'], workflowRuns: ['title', 'workflowId'], workflowRunSteps: ['workflowRunId', 'title'], workflowMetricDefinitions: ['workflowVersionId', 'name'], workflowImprovementProposals: ['title', 'workflowId'], knowledge: ['title', 'content'], reviews: ['title'], insights: ['statement'], principles: ['statement'], mentalModels: ['name'], notes: ['title'], notebookCategories: ['name'], notebookFolders: ['name'], notebookFiles: ['name'], decisions: ['title'], events: ['title'], people: ['name'], externalSources: ['name'], signals: ['title'], opportunities: ['title'], intelligenceBriefs: ['title'], financialAccounts: ['name'], financialCategories: ['name'], financialTransactions: ['title', 'transactionType', 'amountMinor'],
}
...
const allowed: Partial<Record<Entity, string[]>> = { profiles: ['getProfile', 'updateProfile'],
  ...
  results: ['createOutcome', 'getOutcomes', 'updateOutcome'], deliverables: ['createDeliverable', 'getDeliverable', 'listDeliverables', 'updateDeliverable'], resultPackages: ['createResultPackage', 'getResultPackage', 'listResultPackages', 'updateResultPackage'], capabilityPacks: ['createCapabilityPack', 'getCapabilityPack', 'searchCapabilityPacks', 'updateCapabilityPack'], capabilityAssets: ['createCapabilityAssetDraft', 'getCapabilityAsset', 'searchCapabilities', 'updateCapabilityAsset'], capabilityAssetVersions: ['createCapabilityVersionDraft', 'getCapabilityVersion'], capabilityPackItems: ['createCapabilityPackItem'], packApplications: ['getPackApplications'], packApplicationItems: ['getPackApplicationItems'], templateInstances: ['getTemplateInstance'], capabilityImprovementProposals: ['createCapabilityImprovementProposal', 'updateCapabilityImprovementProposal'], workflows: ['createWorkflow', 'getWorkflow', 'listWorkflows', 'updateWorkflow'], workflowVersions: ['createWorkflowVersion', 'getWorkflowVersion', 'updateWorkflowVersion', 'promoteWorkflowVersion', 'rollbackWorkflowVersion'], workflowSteps: ['createWorkflowStep', 'updateWorkflowStep'], workflowGates: ['createWorkflowGate', 'updateWorkflowGate'], workflowRuns: ['createWorkflowRun', 'getWorkflowRun', 'listWorkflowRuns', 'updateWorkflowRun', 'compareWorkflowRuns', 'getWorkflowScorecard'], workflowRunSteps: ['createWorkflowRunStep', 'updateWorkflowRunStep'], workflowMetricDefinitions: ['createWorkflowMetric', 'updateWorkflowMetric'], workflowImprovementProposals: ['createWorkflowImprovementProposal', 'updateWorkflowImprovementProposal'],
...
export const schemaRegistry: SchemaDefinition[] = entities.filter((config) => ['profiles', 'goals', 'projects', 'tasks', 'timeLogs', 'results', 'deliverables', 'resultPackages', 'capabilityPacks', 'capabilityAssets', 'capabilityAssetVersions', 'capabilityPackItems', 'packApplications', 'packApplicationItems', 'templateInstances', 'capabilityImprovementProposals', 'workflows', 'workflowVersions', 'workflowSteps', 'workflowGates', 'workflowRuns', 'workflowRunSteps', 'workflowMetricDefinitions', 'workflowImprovementProposals', 'knowledge', 'reviews', 'insights', 'principles', 'mentalModels', 'notes', 'notebookCategories', 'notebookFolders', 'notebookFiles', 'decisions', 'events', 'people', 'externalSources', 'signals', 'opportunities', 'intelligenceBriefs', 'financialAccounts', 'financialCategories', 'financialTransactions'].includes(config.entity)).map((config) => ({
