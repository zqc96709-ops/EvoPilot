...
try {
  ...
  console.log(JSON.stringify({ status: 'passed', screenshotPath, responseMs, checks: ['real project dashboard fixture', 'period change', 'five-tab project workbench', 'operating state save', 'operational quick capture', 'structured table save', 'materials link visibility', 'review tab', 'UI project creation updates dashboard', '1536 desktop screenshot'] }))
} catch (error) {
